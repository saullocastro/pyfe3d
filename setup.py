...
s = setup(
    ...
    description = ("General-purpose finite element solver for 3D problems based on Python/Cython"),
    license = "3-Clause BSD",
    keywords = "finite element structural analysis static buckling vibration dynamics",
