...
cdef class BeamCurvedLR:
    ...
    cpdef void update_KC0(BeamCurvedLR self,
        ...
        with nogil:
            ...
            k = self.init_k_KC0
            KC0v[k] += 1.0*A*G*r13**2/L + r11*(-0.5*A*E*r12/Rxy + 1.0*A*E*r11/L) + r12*(-0.5*A*E*r11/Rxy + 1.0*L*r12*(A*E/(4*Rxy**2) + A*G/L**2))
            k += 1
            KC0v[k] += 1.0*A*G*r13*r23/L + r21*(-0.5*A*E*r12/Rxy + 1.0*A*E*r11/L) + r22*(-0.5*A*E*r11/Rxy + 1.0*L*r12*(A*E/(4*Rxy**2) + A*G/L**2))
            k += 1
            KC0v[k] += 1.0*A*G*r13*r33/L + r31*(-0.5*A*E*r12/Rxy + 1.0*A*E*r11/L) + r32*(-0.5*A*E*r11/Rxy + 1.0*L*r12*(A*E/(4*Rxy**2) + A*G/L**2))
            k += 1
            KC0v[k] += r11*(1.0*Ay*G*r13/L - 1.0*Az*G*r12/L) + r12*(-0.5*A*G*r13 - 0.5*Az*E*r12/Rxy + 1.0*Az*E*r11/L) + r13*(-1.0*Ay*E*r11/L + 0.5*r12*(A*G*Rxy + Ay*E)/Rxy)
            k += 1
            KC0v[k] += r21*(1.0*Ay*G*r13/L - 1.0*Az*G*r12/L) + r22*(-0.5*A*G*r13 - 0.5*Az*E*r12/Rxy + 1.0*Az*E*r11/L) + r23*(-1.0*Ay*E*r11/L + 0.5*r12*(A*G*Rxy + Ay*E)/Rxy)
            k += 1
            KC0v[k] += r31*(1.0*Ay*G*r13/L - 1.0*Az*G*r12/L) + r32*(-0.5*A*G*r13 - 0.5*Az*E*r12/Rxy + 1.0*Az*E*r11/L) + r33*(-1.0*Ay*E*r11/L + 0.5*r12*(A*G*Rxy + Ay*E)/Rxy)
            k += 1
            KC0v[k] += -1.0*A*G*r13**2/L + r11*(0.5*A*E*r12/Rxy - 1.0*A*E*r11/L) + r12*(-0.5*A*E*r11/Rxy + 1.0*L*r12*(A*E/(4*Rxy**2) - A*G/L**2))
            k += 1
            KC0v[k] += -1.0*A*G*r13*r23/L + r21*(0.5*A*E*r12/Rxy - 1.0*A*E*r11/L) + r22*(-0.5*A*E*r11/Rxy + 1.0*L*r12*(A*E/(4*Rxy**2) - A*G/L**2))
            ...
            KC0v[k] += r31*(-1.0*Ay*G*r13/L + 1.0*Az*G*r12/L) + r32*(-0.5*A*G*r13 + 0.5*Az*E*r12/Rxy - 1.0*Az*E*r11/L) + r33*(1.0*Ay*E*r11/L + 0.5*r12*(A*G*Rxy - Ay*E)/Rxy)
            k += 1
            KC0v[k] += 1.0*A*G*r13*r23/L + r11*(-0.5*A*E*r22/Rxy + 1.0*A*E*r21/L) + r12*(-0.5*A*E*r21/Rxy + 1.0*L*r22*(A*E/(4*Rxy**2) + A*G/L**2))
            k += 1
            KC0v[k] += 1.0*A*G*r23**2/L + r21*(-0.5*A*E*r22/Rxy + 1.0*A*E*r21/L) + r22*(-0.5*A*E*r21/Rxy + 1.0*L*r22*(A*E/(4*Rxy**2) + A*G/L**2))
            k += 1
            KC0v[k] += 1.0*A*G*r23*r33/L + r31*(-0.5*A*E*r22/Rxy + 1.0*A*E*r21/L) + r32*(-0.5*A*E*r21/Rxy + 1.0*L*r22*(A*E/(4*Rxy**2) + A*G/L**2))
            k += 1
            KC0v[k] += r11*(1.0*Ay*G*r23/L - 1.0*Az*G*r22/L) + r12*(-0.5*A*G*r23 - 0.5*Az*E*r22/Rxy + 1.0*Az*E*r21/L) + r13*(-1.0*Ay*E*r21/L + 0.5*r22*(A*G*Rxy + Ay*E)/Rxy)
            k += 1
            KC0v[k] += r21*(1.0*Ay*G*r23/L - 1.0*Az*G*r22/L) + r22*(-0.5*A*G*r23 - 0.5*Az*E*r22/Rxy + 1.0*Az*E*r21/L) + r23*(-1.0*Ay*E*r21/L + 0.5*r22*(A*G*Rxy + Ay*E)/Rxy)
            k += 1
            KC0v[k] += r31*(1.0*Ay*G*r23/L - 1.0*Az*G*r22/L) + r32*(-0.5*A*G*r23 - 0.5*Az*E*r22/Rxy + 1.0*Az*E*r21/L) + r33*(-1.0*Ay*E*r21/L + 0.5*r22*(A*G*Rxy + Ay*E)/Rxy)
            k += 1
            KC0v[k] += -1.0*A*G*r13*r23/L + r11*(0.5*A*E*r22/Rxy - 1.0*A*E*r21/L) + r12*(-0.5*A*E*r21/Rxy + 1.0*L*r22*(A*E/(4*Rxy**2) - A*G/L**2))
            k += 1
            KC0v[k] += -1.0*A*G*r23**2/L + r21*(0.5*A*E*r22/Rxy - 1.0*A*E*r21/L) + r22*(-0.5*A*E*r21/Rxy + 1.0*L*r22*(A*E/(4*Rxy**2) - A*G/L**2))
            ...
            KC0v[k] += r31*(-1.0*Ay*G*r23/L + 1.0*Az*G*r22/L) + r32*(-0.5*A*G*r23 + 0.5*Az*E*r22/Rxy - 1.0*Az*E*r21/L) + r33*(1.0*Ay*E*r21/L + 0.5*r22*(A*G*Rxy - Ay*E)/Rxy)
            k += 1
            KC0v[k] += 1.0*A*G*r13*r33/L + r11*(-0.5*A*E*r32/Rxy + 1.0*A*E*r31/L) + r12*(-0.5*A*E*r31/Rxy + 1.0*L*r32*(A*E/(4*Rxy**2) + A*G/L**2))
            k += 1
            KC0v[k] += 1.0*A*G*r23*r33/L + r21*(-0.5*A*E*r32/Rxy + 1.0*A*E*r31/L) + r22*(-0.5*A*E*r31/Rxy + 1.0*L*r32*(A*E/(4*Rxy**2) + A*G/L**2))
            k += 1
            KC0v[k] += 1.0*A*G*r33**2/L + r31*(-0.5*A*E*r32/Rxy + 1.0*A*E*r31/L) + r32*(-0.5*A*E*r31/Rxy + 1.0*L*r32*(A*E/(4*Rxy**2) + A*G/L**2))
            k += 1
            KC0v[k] += r11*(1.0*Ay*G*r33/L - 1.0*Az*G*r32/L) + r12*(-0.5*A*G*r33 - 0.5*Az*E*r32/Rxy + 1.0*Az*E*r31/L) + r13*(-1.0*Ay*E*r31/L + 0.5*r32*(A*G*Rxy + Ay*E)/Rxy)
            k += 1
            KC0v[k] += r21*(1.0*Ay*G*r33/L - 1.0*Az*G*r32/L) + r22*(-0.5*A*G*r33 - 0.5*Az*E*r32/Rxy + 1.0*Az*E*r31/L) + r23*(-1.0*Ay*E*r31/L + 0.5*r32*(A*G*Rxy + Ay*E)/Rxy)
            k += 1
            KC0v[k] += r31*(1.0*Ay*G*r33/L - 1.0*Az*G*r32/L) + r32*(-0.5*A*G*r33 - 0.5*Az*E*r32/Rxy + 1.0*Az*E*r31/L) + r33*(-1.0*Ay*E*r31/L + 0.5*r32*(A*G*Rxy + Ay*E)/Rxy)
            k += 1
            KC0v[k] += -1.0*A*G*r13*r33/L + r11*(0.5*A*E*r32/Rxy - 1.0*A*E*r31/L) + r12*(-0.5*A*E*r31/Rxy + 1.0*L*r32*(A*E/(4*Rxy**2) - A*G/L**2))
            k += 1
            KC0v[k] += -1.0*A*G*r23*r33/L + r21*(0.5*A*E*r32/Rxy - 1.0*A*E*r31/L) + r22*(-0.5*A*E*r31/Rxy + 1.0*L*r32*(A*E/(4*Rxy**2) - A*G/L**2))
            ...
            KC0v[k] += r31*(-1.0*Ay*G*r33/L + 1.0*Az*G*r32/L) + r32*(-0.5*A*G*r33 + 0.5*Az*E*r32/Rxy - 1.0*Az*E*r31/L) + r33*(1.0*Ay*E*r31/L + 0.5*r32*(A*G*Rxy - Ay*E)/Rxy)
            k += 1
            KC0v[k] += r11*(-1.0*Ay*E*r13/L + 1.0*Az*E*r12/L) + r12*(-0.5*Az*E*r12/Rxy - 1.0*Az*G*r11/L + 0.5*r13*(A*G*Rxy + Ay*E)/Rxy) + r13*(-0.5*A*G*r12 + 1.0*Ay*G*r11/L)
            k += 1
            KC0v[k] += r21*(-1.0*Ay*E*r13/L + 1.0*Az*E*r12/L) + r22*(-0.5*Az*E*r12/Rxy - 1.0*Az*G*r11/L + 0.5*r13*(A*G*Rxy + Ay*E)/Rxy) + r23*(-0.5*A*G*r12 + 1.0*Ay*G*r11/L)
            k += 1
            KC0v[k] += r31*(-1.0*Ay*E*r13/L + 1.0*Az*E*r12/L) + r32*(-0.5*Az*E*r12/Rxy - 1.0*Az*G*r11/L + 0.5*r13*(A*G*Rxy + Ay*E)/Rxy) + r33*(-0.5*A*G*r12 + 1.0*Ay*G*r11/L)
            k += 1
            ...
            KC0v[k] += r31*(0.5*Ay*G*r12 + 0.5*Az*G*r13 - 1.0*G*J*r11/L) + r32*(-0.5*Ay*G*r11 + 1.0*E*Iyz*r13/L + 1.0*L*r12*(A*G/4 - E*Iyy/L**2)) + r33*(-0.5*Az*G*r11 + 1.0*E*Iyz*r12/L + 1.0*L*r13*(A*G/4 - E*Izz/L**2))
            k += 1
            KC0v[k] += r11*(-1.0*Ay*E*r23/L + 1.0*Az*E*r22/L) + r12*(-0.5*Az*E*r22/Rxy - 1.0*Az*G*r21/L + 0.5*r23*(A*G*Rxy + Ay*E)/Rxy) + r13*(-0.5*A*G*r22 + 1.0*Ay*G*r21/L)
            k += 1
            KC0v[k] += r21*(-1.0*Ay*E*r23/L + 1.0*Az*E*r22/L) + r22*(-0.5*Az*E*r22/Rxy - 1.0*Az*G*r21/L + 0.5*r23*(A*G*Rxy + Ay*E)/Rxy) + r23*(-0.5*A*G*r22 + 1.0*Ay*G*r21/L)
            k += 1
            KC0v[k] += r31*(-1.0*Ay*E*r23/L + 1.0*Az*E*r22/L) + r32*(-0.5*Az*E*r22/Rxy - 1.0*Az*G*r21/L + 0.5*r23*(A*G*Rxy + Ay*E)/Rxy) + r33*(-0.5*A*G*r22 + 1.0*Ay*G*r21/L)
            k += 1
            ...
            KC0v[k] += r31*(0.5*Ay*G*r22 + 0.5*Az*G*r23 - 1.0*G*J*r21/L) + r32*(-0.5*Ay*G*r21 + 1.0*E*Iyz*r23/L + 1.0*L*r22*(A*G/4 - E*Iyy/L**2)) + r33*(-0.5*Az*G*r21 + 1.0*E*Iyz*r22/L + 1.0*L*r23*(A*G/4 - E*Izz/L**2))
            k += 1
            KC0v[k] += r11*(-1.0*Ay*E*r33/L + 1.0*Az*E*r32/L) + r12*(-0.5*Az*E*r32/Rxy - 1.0*Az*G*r31/L + 0.5*r33*(A*G*Rxy + Ay*E)/Rxy) + r13*(-0.5*A*G*r32 + 1.0*Ay*G*r31/L)
            k += 1
            KC0v[k] += r21*(-1.0*Ay*E*r33/L + 1.0*Az*E*r32/L) + r22*(-0.5*Az*E*r32/Rxy - 1.0*Az*G*r31/L + 0.5*r33*(A*G*Rxy + Ay*E)/Rxy) + r23*(-0.5*A*G*r32 + 1.0*Ay*G*r31/L)
            k += 1
            KC0v[k] += r31*(-1.0*Ay*E*r33/L + 1.0*Az*E*r32/L) + r32*(-0.5*Az*E*r32/Rxy - 1.0*Az*G*r31/L + 0.5*r33*(A*G*Rxy + Ay*E)/Rxy) + r33*(-0.5*A*G*r32 + 1.0*Ay*G*r31/L)
            k += 1
