...
cdef class BeamC:
    ...
    cpdef void update_KG(BeamC self,
        ...
        with nogil:
            ...
            k += 1
            KGv[k] += r22*(6*A**2*G**2*L**3*N*r12*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - 6*A**2*G**2*L**3*N*r13*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz)) + r23*(-6*A**2*G**2*L**3*N*r12*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz) + 6*A**2*G**2*L**3*N*r13*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)))
            k += 1
            KGv[k] += r32*(6*A**2*G**2*L**3*N*r12*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - 6*A**2*G**2*L**3*N*r13*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz)) + r33*(-6*A**2*G**2*L**3*N*r12*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz) + 6*A**2*G**2*L**3*N*r13*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)))
            k += 1
            KGv[k] += r12*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r13*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r22*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r23*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r32*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r33*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r12*(-6*A**2*G**2*L**3*N*r12*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2) + 6*A**2*G**2*L**3*N*r13*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r13*(6*A**2*G**2*L**3*N*r12*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - 6*A**2*G**2*L**3*N*r13*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2))
            k += 1
            KGv[k] += r22*(-6*A**2*G**2*L**3*N*r12*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2) + 6*A**2*G**2*L**3*N*r13*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r23*(6*A**2*G**2*L**3*N*r12*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - 6*A**2*G**2*L**3*N*r13*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2))
            k += 1
            KGv[k] += r32*(-6*A**2*G**2*L**3*N*r12*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2) + 6*A**2*G**2*L**3*N*r13*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r33*(6*A**2*G**2*L**3*N*r12*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - 6*A**2*G**2*L**3*N*r13*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2))
            k += 1
            KGv[k] += r12*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r13*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r22*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r23*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            ...
            KGv[k] += r32*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r33*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r12*(6*A**2*G**2*L**3*N*r22*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - 6*A**2*G**2*L**3*N*r23*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz)) + r13*(-6*A**2*G**2*L**3*N*r22*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz) + 6*A**2*G**2*L**3*N*r23*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)))
            k += 1
            KGv[k] += r22*(6*A**2*G**2*L**3*N*r22*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - 6*A**2*G**2*L**3*N*r23*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz)) + r23*(-6*A**2*G**2*L**3*N*r22*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz) + 6*A**2*G**2*L**3*N*r23*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)))
            k += 1
            KGv[k] += r32*(6*A**2*G**2*L**3*N*r22*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - 6*A**2*G**2*L**3*N*r23*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz)) + r33*(-6*A**2*G**2*L**3*N*r22*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz) + 6*A**2*G**2*L**3*N*r23*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)))
            k += 1
            KGv[k] += r12*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r13*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r22*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r23*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r32*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r33*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r12*(-6*A**2*G**2*L**3*N*r22*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2) + 6*A**2*G**2*L**3*N*r23*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r13*(6*A**2*G**2*L**3*N*r22*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - 6*A**2*G**2*L**3*N*r23*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2))
            k += 1
            KGv[k] += r22*(-6*A**2*G**2*L**3*N*r22*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2) + 6*A**2*G**2*L**3*N*r23*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r23*(6*A**2*G**2*L**3*N*r22*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - 6*A**2*G**2*L**3*N*r23*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2))
            k += 1
            KGv[k] += r32*(-6*A**2*G**2*L**3*N*r22*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2) + 6*A**2*G**2*L**3*N*r23*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r33*(6*A**2*G**2*L**3*N*r22*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - 6*A**2*G**2*L**3*N*r23*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2))
            k += 1
            KGv[k] += r12*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r13*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r22*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r23*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            ...
            KGv[k] += r32*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r33*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r12*(6*A**2*G**2*L**3*N*r32*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - 6*A**2*G**2*L**3*N*r33*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz)) + r13*(-6*A**2*G**2*L**3*N*r32*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz) + 6*A**2*G**2*L**3*N*r33*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)))
            k += 1
            KGv[k] += r22*(6*A**2*G**2*L**3*N*r32*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - 6*A**2*G**2*L**3*N*r33*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz)) + r23*(-6*A**2*G**2*L**3*N*r32*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz) + 6*A**2*G**2*L**3*N*r33*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)))
            k += 1
            KGv[k] += r32*(6*A**2*G**2*L**3*N*r32*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - 6*A**2*G**2*L**3*N*r33*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz)) + r33*(-6*A**2*G**2*L**3*N*r32*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz) + 6*A**2*G**2*L**3*N*r33*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)))
            k += 1
            KGv[k] += r12*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r13*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r22*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r23*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r32*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r33*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r12*(-6*A**2*G**2*L**3*N*r32*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2) + 6*A**2*G**2*L**3*N*r33*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r13*(6*A**2*G**2*L**3*N*r32*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - 6*A**2*G**2*L**3*N*r33*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2))
            k += 1
            KGv[k] += r22*(-6*A**2*G**2*L**3*N*r32*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2) + 6*A**2*G**2*L**3*N*r33*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r23*(6*A**2*G**2*L**3*N*r32*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - 6*A**2*G**2*L**3*N*r33*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2))
            k += 1
            KGv[k] += r32*(-6*A**2*G**2*L**3*N*r32*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2) + 6*A**2*G**2*L**3*N*r33*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r33*(6*A**2*G**2*L**3*N*r32*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - 6*A**2*G**2*L**3*N*r33*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2))
            k += 1
            KGv[k] += r12*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r13*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r22*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r23*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            ...
            KGv[k] += r32*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2))) + r33*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r12*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2))) + r13*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r22*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2))) + r23*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r32*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2))) + r33*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r12*(2*L*N*r12*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Iyy*L**2*scf + 360*E**2*Iyy**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r13*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r13*(L*N*r12*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + 2*L*N*r13*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Izz*L**2*scf + 360*E**2*Izz**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r22*(2*L*N*r12*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Iyy*L**2*scf + 360*E**2*Iyy**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r13*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r23*(L*N*r12*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + 2*L*N*r13*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Izz*L**2*scf + 360*E**2*Izz**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r32*(2*L*N*r12*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Iyy*L**2*scf + 360*E**2*Iyy**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r13*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r33*(L*N*r12*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + 2*L*N*r13*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Izz*L**2*scf + 360*E**2*Izz**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r12*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2)) + r13*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r22*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2)) + r23*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r32*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2)) + r33*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r12*(L*N*r12*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r13*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r13*(L*N*r12*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + L*N*r13*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r22*(L*N*r12*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r13*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r23*(L*N*r12*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + L*N*r13*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r32*(L*N*r12*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r13*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r33*(L*N*r12*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + L*N*r13*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r12*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2))) + r13*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r22*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2))) + r23*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r32*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2))) + r33*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r12*(2*L*N*r22*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Iyy*L**2*scf + 360*E**2*Iyy**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r23*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r13*(L*N*r22*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + 2*L*N*r23*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Izz*L**2*scf + 360*E**2*Izz**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r22*(2*L*N*r22*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Iyy*L**2*scf + 360*E**2*Iyy**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r23*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r23*(L*N*r22*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + 2*L*N*r23*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Izz*L**2*scf + 360*E**2*Izz**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r32*(2*L*N*r22*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Iyy*L**2*scf + 360*E**2*Iyy**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r23*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r33*(L*N*r22*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + 2*L*N*r23*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Izz*L**2*scf + 360*E**2*Izz**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r12*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2)) + r13*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r22*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2)) + r23*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r32*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2)) + r33*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r12*(L*N*r22*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r23*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r13*(L*N*r22*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + L*N*r23*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r22*(L*N*r22*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r23*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r23*(L*N*r22*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + L*N*r23*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r32*(L*N*r22*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r23*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r33*(L*N*r22*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + L*N*r23*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r12*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2))) + r13*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r22*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2))) + r23*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r32*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2))) + r33*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf - 120*A*E*G*Izz*L**2*scf + 1440*E**2*Iyy*Izz))
            k += 1
            KGv[k] += r12*(2*L*N*r32*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Iyy*L**2*scf + 360*E**2*Iyy**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r33*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r13*(L*N*r32*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + 2*L*N*r33*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Izz*L**2*scf + 360*E**2*Izz**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r22*(2*L*N*r32*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Iyy*L**2*scf + 360*E**2*Iyy**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r33*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r23*(L*N*r32*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + 2*L*N*r33*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Izz*L**2*scf + 360*E**2*Izz**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r32*(2*L*N*r32*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Iyy*L**2*scf + 360*E**2*Iyy**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r33*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r33*(L*N*r32*(-2*A**2*G**2*L**4*scf**2 + 15*A*E*G*Iyy*L**2*scf + 15*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(15*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + 2*L*N*r33*(A**2*G**2*L**4*scf**2 - 15*A*E*G*Izz*L**2*scf + 360*E**2*Izz**2)/(15*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r12*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2)) + r13*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r22*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2)) + r23*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r32*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2)) + r33*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r12*(L*N*r32*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r33*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r13*(L*N*r32*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + L*N*r33*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r22*(L*N*r32*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r33*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r23*(L*N*r32*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + L*N*r33*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r32*(L*N*r32*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)) + L*N*r33*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r33*(L*N*r32*(A**2*G**2*L**4*scf**2 - 30*A*E*G*Iyy*L**2*scf - 30*A*E*G*Izz*L**2*scf - 720*E**2*Iyy*Izz)/(30*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) + L*N*r33*(-A**2*G**2*L**4*scf**2 + 60*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2)/(30*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)))
            k += 1
            KGv[k] += r12*(-6*A**2*G**2*L**3*N*r12*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2) + 6*A**2*G**2*L**3*N*r13*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r13*(6*A**2*G**2*L**3*N*r12*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - 6*A**2*G**2*L**3*N*r13*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2))
            k += 1
            KGv[k] += r22*(-6*A**2*G**2*L**3*N*r12*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2) + 6*A**2*G**2*L**3*N*r13*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r23*(6*A**2*G**2*L**3*N*r12*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - 6*A**2*G**2*L**3*N*r13*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2))
            ...
            KGv[k] += r32*(-6*A**2*G**2*L**3*N*r12*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2) + 6*A**2*G**2*L**3*N*r13*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r33*(6*A**2*G**2*L**3*N*r12*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - 6*A**2*G**2*L**3*N*r13*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2))
            k += 1
            KGv[k] += r12*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2)) + r13*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r22*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2)) + r23*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r32*(A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2)) + r33*(-A*G*L**2*N*r12*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2) + A*G*L**2*N*r13*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r12*(6*A**2*G**2*L**3*N*r12*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - 6*A**2*G**2*L**3*N*r13*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz)) + r13*(-6*A**2*G**2*L**3*N*r12*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz) + 6*A**2*G**2*L**3*N*r13*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)))
            k += 1
            KGv[k] += r22*(6*A**2*G**2*L**3*N*r12*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - 6*A**2*G**2*L**3*N*r13*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz)) + r23*(-6*A**2*G**2*L**3*N*r12*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz) + 6*A**2*G**2*L**3*N*r13*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)))
            ...
            KGv[k] += r32*(-6*A**2*G**2*L**3*N*r22*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2) + 6*A**2*G**2*L**3*N*r23*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r33*(6*A**2*G**2*L**3*N*r22*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - 6*A**2*G**2*L**3*N*r23*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2))
            k += 1
            KGv[k] += r12*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2)) + r13*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r22*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2)) + r23*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r32*(A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2)) + r33*(-A*G*L**2*N*r22*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2) + A*G*L**2*N*r23*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r12*(6*A**2*G**2*L**3*N*r22*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - 6*A**2*G**2*L**3*N*r23*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz)) + r13*(-6*A**2*G**2*L**3*N*r22*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz) + 6*A**2*G**2*L**3*N*r23*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)))
            k += 1
            KGv[k] += r22*(6*A**2*G**2*L**3*N*r22*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - 6*A**2*G**2*L**3*N*r23*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz)) + r23*(-6*A**2*G**2*L**3*N*r22*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz) + 6*A**2*G**2*L**3*N*r23*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)))
            ...
            KGv[k] += r32*(-6*A**2*G**2*L**3*N*r32*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Izz*L**2*scf + 720*E**2*Izz**2) + 6*A**2*G**2*L**3*N*r33*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz))) + r33*(6*A**2*G**2*L**3*N*r32*scf**2/(5*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - 6*A**2*G**2*L**3*N*r33*scf**2/(5*A**2*G**2*L**4*scf**2 - 120*A*E*G*Iyy*L**2*scf + 720*E**2*Iyy**2))
            k += 1
            KGv[k] += r12*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2)) + r13*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r22*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2)) + r23*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r32*(A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)) - A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Iyy)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Iyy*L**2*scf + 1440*E**2*Iyy**2)) + r33*(-A*G*L**2*N*r32*scf*(A*G*L**2*scf + 60*E*Izz)/(10*A**2*G**2*L**4*scf**2 - 240*A*E*G*Izz*L**2*scf + 1440*E**2*Izz**2) + A*G*L**2*N*r33*scf*(A*G*L**2*scf + 60*E*Izz)/(10*(A**2*G**2*L**4*scf**2 - 12*A*E*G*Iyy*L**2*scf - 12*A*E*G*Izz*L**2*scf + 144*E**2*Iyy*Izz)))
            k += 1
            KGv[k] += r12*(6*A**2*G**2*L**3*N*r32*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - 6*A**2*G**2*L**3*N*r33*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz)) + r13*(-6*A**2*G**2*L**3*N*r32*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz) + 6*A**2*G**2*L**3*N*r33*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)))
            k += 1
            KGv[k] += r22*(6*A**2*G**2*L**3*N*r32*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Izz*L**2*scf + 144*E**2*Izz**2)) - 6*A**2*G**2*L**3*N*r33*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz)) + r23*(-6*A**2*G**2*L**3*N*r32*scf**2/(5*A**2*G**2*L**4*scf**2 - 60*A*E*G*Iyy*L**2*scf - 60*A*E*G*Izz*L**2*scf + 720*E**2*Iyy*Izz) + 6*A**2*G**2*L**3*N*r33*scf**2/(5*(A**2*G**2*L**4*scf**2 - 24*A*E*G*Iyy*L**2*scf + 144*E**2*Iyy**2)))
