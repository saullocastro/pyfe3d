...
cdef class BeamLR:
    ...
    cpdef void update_KC0(BeamLR self,
        ...
        with nogil:
            ...
            k = self.init_k_KC0
            KC0v[k] += 1.0*A*E*r11**2/L + 1.0*A*G*r12**2*scf/L + 1.0*A*G*r13**2*scf/L
            k += 1
            KC0v[k] += 1.0*A*E*r11*r21/L + 1.0*A*G*r12*r22*scf/L + 1.0*A*G*r13*r23*scf/L
            k += 1
            KC0v[k] += 1.0*A*E*r11*r31/L + 1.0*A*G*r12*r32*scf/L + 1.0*A*G*r13*r33*scf/L
            k += 1
            KC0v[k] += r11*(-1.0*Ay*G*r13*scf/L - 1.0*Az*G*r12*scf/L) + r12*(-0.5*A*G*r13*scf + 1.0*Az*E*r11/L) + r13*(0.5*A*G*r12*scf - 1.0*Ay*E*r11/L)
            k += 1
            KC0v[k] += r21*(-1.0*Ay*G*r13*scf/L - 1.0*Az*G*r12*scf/L) + r22*(-0.5*A*G*r13*scf + 1.0*Az*E*r11/L) + r23*(0.5*A*G*r12*scf - 1.0*Ay*E*r11/L)
            k += 1
            KC0v[k] += r31*(-1.0*Ay*G*r13*scf/L - 1.0*Az*G*r12*scf/L) + r32*(-0.5*A*G*r13*scf + 1.0*Az*E*r11/L) + r33*(0.5*A*G*r12*scf - 1.0*Ay*E*r11/L)
            k += 1
            KC0v[k] += -1.0*A*E*r11**2/L - 1.0*A*G*r12**2*scf/L - 1.0*A*G*r13**2*scf/L
            k += 1
            KC0v[k] += -1.0*A*E*r11*r21/L - 1.0*A*G*r12*r22*scf/L - 1.0*A*G*r13*r23*scf/L
            ...
            KC0v[k] += 1.0*A*E*r11*r21/L + 1.0*A*G*r12*r22*scf/L + 1.0*A*G*r13*r23*scf/L
            k += 1
            KC0v[k] += 1.0*A*E*r21**2/L + 1.0*A*G*r22**2*scf/L + 1.0*A*G*r23**2*scf/L
            k += 1
            KC0v[k] += 1.0*A*E*r21*r31/L + 1.0*A*G*r22*r32*scf/L + 1.0*A*G*r23*r33*scf/L
            k += 1
            KC0v[k] += r11*(-1.0*Ay*G*r23*scf/L - 1.0*Az*G*r22*scf/L) + r12*(-0.5*A*G*r23*scf + 1.0*Az*E*r21/L) + r13*(0.5*A*G*r22*scf - 1.0*Ay*E*r21/L)
            k += 1
            KC0v[k] += r21*(-1.0*Ay*G*r23*scf/L - 1.0*Az*G*r22*scf/L) + r22*(-0.5*A*G*r23*scf + 1.0*Az*E*r21/L) + r23*(0.5*A*G*r22*scf - 1.0*Ay*E*r21/L)
            k += 1
            KC0v[k] += r31*(-1.0*Ay*G*r23*scf/L - 1.0*Az*G*r22*scf/L) + r32*(-0.5*A*G*r23*scf + 1.0*Az*E*r21/L) + r33*(0.5*A*G*r22*scf - 1.0*Ay*E*r21/L)
            k += 1
            KC0v[k] += -1.0*A*E*r11*r21/L - 1.0*A*G*r12*r22*scf/L - 1.0*A*G*r13*r23*scf/L
            k += 1
            KC0v[k] += -1.0*A*E*r21**2/L - 1.0*A*G*r22**2*scf/L - 1.0*A*G*r23**2*scf/L
            ...
            KC0v[k] += 1.0*A*E*r21*r31/L + 1.0*A*G*r22*r32*scf/L + 1.0*A*G*r23*r33*scf/L
            k += 1
            KC0v[k] += 1.0*A*E*r31**2/L + 1.0*A*G*r32**2*scf/L + 1.0*A*G*r33**2*scf/L
            k += 1
            KC0v[k] += r11*(-1.0*Ay*G*r33*scf/L - 1.0*Az*G*r32*scf/L) + r12*(-0.5*A*G*r33*scf + 1.0*Az*E*r31/L) + r13*(0.5*A*G*r32*scf - 1.0*Ay*E*r31/L)
            k += 1
            KC0v[k] += r21*(-1.0*Ay*G*r33*scf/L - 1.0*Az*G*r32*scf/L) + r22*(-0.5*A*G*r33*scf + 1.0*Az*E*r31/L) + r23*(0.5*A*G*r32*scf - 1.0*Ay*E*r31/L)
            k += 1
            KC0v[k] += r31*(-1.0*Ay*G*r33*scf/L - 1.0*Az*G*r32*scf/L) + r32*(-0.5*A*G*r33*scf + 1.0*Az*E*r31/L) + r33*(0.5*A*G*r32*scf - 1.0*Ay*E*r31/L)
            k += 1
            KC0v[k] += -1.0*A*E*r11*r31/L - 1.0*A*G*r12*r32*scf/L - 1.0*A*G*r13*r33*scf/L
            k += 1
            KC0v[k] += -1.0*A*E*r21*r31/L - 1.0*A*G*r22*r32*scf/L - 1.0*A*G*r23*r33*scf/L
            ...
            KC0v[k] += r31*(1.0*Ay*G*r33*scf/L + 1.0*Az*G*r32*scf/L) + r32*(-0.5*A*G*r33*scf - 1.0*Az*E*r31/L) + r33*(0.5*A*G*r32*scf + 1.0*Ay*E*r31/L)
            k += 1
            KC0v[k] += r11*(-1.0*Ay*E*r13/L + 1.0*Az*E*r12/L) + r12*(0.5*A*G*r13*scf - 1.0*Az*G*r11*scf/L) + r13*(-0.5*A*G*r12*scf + 1.0*Ay*G*r11*scf/L)
            k += 1
            KC0v[k] += r21*(-1.0*Ay*E*r13/L + 1.0*Az*E*r12/L) + r22*(0.5*A*G*r13*scf - 1.0*Az*G*r11*scf/L) + r23*(-0.5*A*G*r12*scf + 1.0*Ay*G*r11*scf/L)
            k += 1
            KC0v[k] += r31*(-1.0*Ay*E*r13/L + 1.0*Az*E*r12/L) + r32*(0.5*A*G*r13*scf - 1.0*Az*G*r11*scf/L) + r33*(-0.5*A*G*r12*scf + 1.0*Ay*G*r11*scf/L)
            k += 1
            KC0v[k] += r11*(0.5*Ay*G*r12*scf - 0.5*Az*G*r13*scf - 1.0*G*r11*scf*(Iyy + Izz)/L) + r12*(-0.5*Ay*G*r11*scf - 1.0*E*J*r13/L + 1.0*L*r12*(A*G*scf/4 + E*Iyy/L**2)) + r13*(-0.5*Az*G*r11*scf - 1.0*E*J*r12/L + 1.0*L*r13*(A*G*scf/4 + E*Izz/L**2))
            k += 1
            KC0v[k] += r21*(0.5*Ay*G*r12*scf - 0.5*Az*G*r13*scf - 1.0*G*r11*scf*(Iyy + Izz)/L) + r22*(-0.5*Ay*G*r11*scf - 1.0*E*J*r13/L + 1.0*L*r12*(A*G*scf/4 + E*Iyy/L**2)) + r23*(-0.5*Az*G*r11*scf - 1.0*E*J*r12/L + 1.0*L*r13*(A*G*scf/4 + E*Izz/L**2))
            k += 1
            KC0v[k] += r31*(0.5*Ay*G*r12*scf - 0.5*Az*G*r13*scf - 1.0*G*r11*scf*(Iyy + Izz)/L) + r32*(-0.5*Ay*G*r11*scf - 1.0*E*J*r13/L + 1.0*L*r12*(A*G*scf/4 + E*Iyy/L**2)) + r33*(-0.5*Az*G*r11*scf - 1.0*E*J*r12/L + 1.0*L*r13*(A*G*scf/4 + E*Izz/L**2))
            k += 1
            KC0v[k] += r11*(1.0*Ay*E*r13/L - 1.0*Az*E*r12/L) + r12*(-0.5*A*G*r13*scf + 1.0*Az*G*r11*scf/L) + r13*(0.5*A*G*r12*scf - 1.0*Ay*G*r11*scf/L)
            k += 1
            KC0v[k] += r21*(1.0*Ay*E*r13/L - 1.0*Az*E*r12/L) + r22*(-0.5*A*G*r13*scf + 1.0*Az*G*r11*scf/L) + r23*(0.5*A*G*r12*scf - 1.0*Ay*G*r11*scf/L)
            ...
            KC0v[k] += r31*(-0.5*Ay*G*r12*scf + 0.5*Az*G*r13*scf + 1.0*G*r11*scf*(Iyy + Izz)/L) + r32*(-0.5*Ay*G*r11*scf + 1.0*E*J*r13/L + 1.0*L*r12*(A*G*scf/4 - E*Iyy/L**2)) + r33*(-0.5*Az*G*r11*scf + 1.0*E*J*r12/L + 1.0*L*r13*(A*G*scf/4 - E*Izz/L**2))
            k += 1
            KC0v[k] += r11*(-1.0*Ay*E*r23/L + 1.0*Az*E*r22/L) + r12*(0.5*A*G*r23*scf - 1.0*Az*G*r21*scf/L) + r13*(-0.5*A*G*r22*scf + 1.0*Ay*G*r21*scf/L)
            k += 1
            KC0v[k] += r21*(-1.0*Ay*E*r23/L + 1.0*Az*E*r22/L) + r22*(0.5*A*G*r23*scf - 1.0*Az*G*r21*scf/L) + r23*(-0.5*A*G*r22*scf + 1.0*Ay*G*r21*scf/L)
            k += 1
            KC0v[k] += r31*(-1.0*Ay*E*r23/L + 1.0*Az*E*r22/L) + r32*(0.5*A*G*r23*scf - 1.0*Az*G*r21*scf/L) + r33*(-0.5*A*G*r22*scf + 1.0*Ay*G*r21*scf/L)
            k += 1
            KC0v[k] += r11*(0.5*Ay*G*r22*scf - 0.5*Az*G*r23*scf - 1.0*G*r21*scf*(Iyy + Izz)/L) + r12*(-0.5*Ay*G*r21*scf - 1.0*E*J*r23/L + 1.0*L*r22*(A*G*scf/4 + E*Iyy/L**2)) + r13*(-0.5*Az*G*r21*scf - 1.0*E*J*r22/L + 1.0*L*r23*(A*G*scf/4 + E*Izz/L**2))
            k += 1
            KC0v[k] += r21*(0.5*Ay*G*r22*scf - 0.5*Az*G*r23*scf - 1.0*G*r21*scf*(Iyy + Izz)/L) + r22*(-0.5*Ay*G*r21*scf - 1.0*E*J*r23/L + 1.0*L*r22*(A*G*scf/4 + E*Iyy/L**2)) + r23*(-0.5*Az*G*r21*scf - 1.0*E*J*r22/L + 1.0*L*r23*(A*G*scf/4 + E*Izz/L**2))
            k += 1
            KC0v[k] += r31*(0.5*Ay*G*r22*scf - 0.5*Az*G*r23*scf - 1.0*G*r21*scf*(Iyy + Izz)/L) + r32*(-0.5*Ay*G*r21*scf - 1.0*E*J*r23/L + 1.0*L*r22*(A*G*scf/4 + E*Iyy/L**2)) + r33*(-0.5*Az*G*r21*scf - 1.0*E*J*r22/L + 1.0*L*r23*(A*G*scf/4 + E*Izz/L**2))
            k += 1
            KC0v[k] += r11*(1.0*Ay*E*r23/L - 1.0*Az*E*r22/L) + r12*(-0.5*A*G*r23*scf + 1.0*Az*G*r21*scf/L) + r13*(0.5*A*G*r22*scf - 1.0*Ay*G*r21*scf/L)
            k += 1
            KC0v[k] += r21*(1.0*Ay*E*r23/L - 1.0*Az*E*r22/L) + r22*(-0.5*A*G*r23*scf + 1.0*Az*G*r21*scf/L) + r23*(0.5*A*G*r22*scf - 1.0*Ay*G*r21*scf/L)
            ...
            KC0v[k] += r31*(-0.5*Ay*G*r22*scf + 0.5*Az*G*r23*scf + 1.0*G*r21*scf*(Iyy + Izz)/L) + r32*(-0.5*Ay*G*r21*scf + 1.0*E*J*r23/L + 1.0*L*r22*(A*G*scf/4 - E*Iyy/L**2)) + r33*(-0.5*Az*G*r21*scf + 1.0*E*J*r22/L + 1.0*L*r23*(A*G*scf/4 - E*Izz/L**2))
            k += 1
            KC0v[k] += r11*(-1.0*Ay*E*r33/L + 1.0*Az*E*r32/L) + r12*(0.5*A*G*r33*scf - 1.0*Az*G*r31*scf/L) + r13*(-0.5*A*G*r32*scf + 1.0*Ay*G*r31*scf/L)
            k += 1
            KC0v[k] += r21*(-1.0*Ay*E*r33/L + 1.0*Az*E*r32/L) + r22*(0.5*A*G*r33*scf - 1.0*Az*G*r31*scf/L) + r23*(-0.5*A*G*r32*scf + 1.0*Ay*G*r31*scf/L)
            k += 1
            KC0v[k] += r31*(-1.0*Ay*E*r33/L + 1.0*Az*E*r32/L) + r32*(0.5*A*G*r33*scf - 1.0*Az*G*r31*scf/L) + r33*(-0.5*A*G*r32*scf + 1.0*Ay*G*r31*scf/L)
            k += 1
            KC0v[k] += r11*(0.5*Ay*G*r32*scf - 0.5*Az*G*r33*scf - 1.0*G*r31*scf*(Iyy + Izz)/L) + r12*(-0.5*Ay*G*r31*scf - 1.0*E*J*r33/L + 1.0*L*r32*(A*G*scf/4 + E*Iyy/L**2)) + r13*(-0.5*Az*G*r31*scf - 1.0*E*J*r32/L + 1.0*L*r33*(A*G*scf/4 + E*Izz/L**2))
            k += 1
            KC0v[k] += r21*(0.5*Ay*G*r32*scf - 0.5*Az*G*r33*scf - 1.0*G*r31*scf*(Iyy + Izz)/L) + r22*(-0.5*Ay*G*r31*scf - 1.0*E*J*r33/L + 1.0*L*r32*(A*G*scf/4 + E*Iyy/L**2)) + r23*(-0.5*Az*G*r31*scf - 1.0*E*J*r32/L + 1.0*L*r33*(A*G*scf/4 + E*Izz/L**2))
            k += 1
            KC0v[k] += r31*(0.5*Ay*G*r32*scf - 0.5*Az*G*r33*scf - 1.0*G*r31*scf*(Iyy + Izz)/L) + r32*(-0.5*Ay*G*r31*scf - 1.0*E*J*r33/L + 1.0*L*r32*(A*G*scf/4 + E*Iyy/L**2)) + r33*(-0.5*Az*G*r31*scf - 1.0*E*J*r32/L + 1.0*L*r33*(A*G*scf/4 + E*Izz/L**2))
            k += 1
            KC0v[k] += r11*(1.0*Ay*E*r33/L - 1.0*Az*E*r32/L) + r12*(-0.5*A*G*r33*scf + 1.0*Az*G*r31*scf/L) + r13*(0.5*A*G*r32*scf - 1.0*Ay*G*r31*scf/L)
            k += 1
            KC0v[k] += r21*(1.0*Ay*E*r33/L - 1.0*Az*E*r32/L) + r22*(-0.5*A*G*r33*scf + 1.0*Az*G*r31*scf/L) + r23*(0.5*A*G*r32*scf - 1.0*Ay*G*r31*scf/L)
