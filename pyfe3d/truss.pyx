...
cdef class Truss:
    ...
    cpdef void update_KG(Truss self,
        ...
        with nogil:
            ...
            k = self.init_k_KG
            KGv[k] += r12*(1.0*N*r12/L + 1.0*N*r13/L) + r13*(1.0*N*r12/L + 1.0*N*r13/L)
            k += 1
            KGv[k] += r22*(1.0*N*r12/L + 1.0*N*r13/L) + r23*(1.0*N*r12/L + 1.0*N*r13/L)
            k += 1
            KGv[k] += r32*(1.0*N*r12/L + 1.0*N*r13/L) + r33*(1.0*N*r12/L + 1.0*N*r13/L)
            k += 1
            KGv[k] += r12*(-1.0*N*r12/L - 1.0*N*r13/L) + r13*(-1.0*N*r12/L - 1.0*N*r13/L)
            k += 1
            KGv[k] += r22*(-1.0*N*r12/L - 1.0*N*r13/L) + r23*(-1.0*N*r12/L - 1.0*N*r13/L)
            ...
            KGv[k] += r32*(-1.0*N*r12/L - 1.0*N*r13/L) + r33*(-1.0*N*r12/L - 1.0*N*r13/L)
            k += 1
            KGv[k] += r12*(1.0*N*r22/L + 1.0*N*r23/L) + r13*(1.0*N*r22/L + 1.0*N*r23/L)
            k += 1
            KGv[k] += r22*(1.0*N*r22/L + 1.0*N*r23/L) + r23*(1.0*N*r22/L + 1.0*N*r23/L)
            k += 1
            KGv[k] += r32*(1.0*N*r22/L + 1.0*N*r23/L) + r33*(1.0*N*r22/L + 1.0*N*r23/L)
            k += 1
            KGv[k] += r12*(-1.0*N*r22/L - 1.0*N*r23/L) + r13*(-1.0*N*r22/L - 1.0*N*r23/L)
            k += 1
            KGv[k] += r22*(-1.0*N*r22/L - 1.0*N*r23/L) + r23*(-1.0*N*r22/L - 1.0*N*r23/L)
            ...
            KGv[k] += r32*(-1.0*N*r22/L - 1.0*N*r23/L) + r33*(-1.0*N*r22/L - 1.0*N*r23/L)
            k += 1
            KGv[k] += r12*(1.0*N*r32/L + 1.0*N*r33/L) + r13*(1.0*N*r32/L + 1.0*N*r33/L)
            k += 1
            KGv[k] += r22*(1.0*N*r32/L + 1.0*N*r33/L) + r23*(1.0*N*r32/L + 1.0*N*r33/L)
            k += 1
            KGv[k] += r32*(1.0*N*r32/L + 1.0*N*r33/L) + r33*(1.0*N*r32/L + 1.0*N*r33/L)
            k += 1
            KGv[k] += r12*(-1.0*N*r32/L - 1.0*N*r33/L) + r13*(-1.0*N*r32/L - 1.0*N*r33/L)
            k += 1
            KGv[k] += r22*(-1.0*N*r32/L - 1.0*N*r33/L) + r23*(-1.0*N*r32/L - 1.0*N*r33/L)
